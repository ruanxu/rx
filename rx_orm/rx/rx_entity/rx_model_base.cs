...
namespace rx
{
    ...
    /// </summary>
    public abstract class rx_model_base : rx_strong_type
    {
        internal rx_model_base(string entity_name) : base(entity_name) { }
        ...
        public new rx_model_base set_where_keys(params string[] where_keys)
        {
            return base.set_where_keys(where_keys) as rx_model_base;
        }

        /// <summary>
        /// 删除所有的where_keys
        /// </summary>
        public new rx_model_base clear_where_keys()
        {
            return base.clear_where_keys() as rx_model_base;
        }
